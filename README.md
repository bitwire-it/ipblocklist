...
![Inbound IPs](https://img.shields.io/badge/Inbound_IPs-2.2M-red?style=flat-square) ![Outbound IPs](https://img.shields.io/badge/Outbound_IPs-164.3K-orange?style=flat-square) ![Total IPs](https://img.shields.io/badge/Total_IPs-2.3M-blue?style=flat-square) ![Last Updated](https://img.shields.io/badge/Last_Updated-2025--12--11-green?style=flat-square)

- **Inbound Blocklist**: 2,157,203 networks/IPs covering 2,154,718 individual IP addresses
- **Outbound Blocklist**: 165,659 networks/IPs covering 164,262 individual IP addresses
- **Total Coverage**: 2,318,980 individual IP addresses
...
*This README is automatically updated by the update script on 2025-12-11 15:21:38 UTC.*
